 ...
 * Diet -> Progress's ProgressTrendChart (toggleable %-of-target lines, dashed
 * 100% reference line, hover crosshair), per the spec's own instruction to
 * stay "consistent with however the Diet tab already visualizes macros."
 * Copied rather than imported cross-feature since the Diet one is scoped to
 * Diet -> Progress's own day-entry shape in its doc comments. */
export default function MacroTrendChart({ days, target, hoverIndex, onHoverChange }: Props) {
